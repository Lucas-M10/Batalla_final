...
from sistemaOleada2 import SistemaOleada
from entidad2 import Fondo
...
def ejecutar_minijuego1():
    ...
    pygame.display.set_caption("La Odisea")
    clock = pygame.time.Clock()

    font = pygame.font.SysFont(None, 40)

    # imagen para fondo
    fondo = Fondo("animacion/fondo/fondo_final.png", ANCHO, ALTO)
